...
const slotSchema = new mongoose.Schema({
  ...
  scheduleId: { type: mongoose.Schema.Types.ObjectId, ref: 'ProcurementSchedule', index: true },
  commodityIds: [{ type: mongoose.Schema.Types.ObjectId, ref: 'Commodity' }],
  supportedCommodities: [{ type: String, trim: true }],
  date: { type: Date, required: true, index: true },
  startTime: { type: String, required: true },
  endTime: { type: String, required: true },
  timezone: { type: String, default: 'Asia/Kolkata' },
  maxFarmers: { type: Number, required: true, min: 1 },

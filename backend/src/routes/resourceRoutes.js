...
const router = Router();
const protectedPath = /^\/(bookings|staff|admin|queue)(\/|$)/;
...
router.get('/queue', authorize('staff', 'admin'), asyncHandler(controller.listQueue));
...
router.post('/staff/check-in', authorize('staff', 'admin'), asyncHandler(controller.checkIn));
router.patch('/staff/queue/:id/status', authorize('staff', 'admin'), validate(queueStatusSchema), asyncHandler(controller.updateQueue));
router.patch('/queue/:id/status', authorize('staff', 'admin'), validate(queueStatusSchema), asyncHandler(controller.updateQueue));

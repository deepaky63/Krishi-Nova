...
export const slotSchema = z.object({ centreId: id, commodityIds: z.array(id).min(1), date: z.coerce.date(), startTime: z.string(), endTime: z.string(), maxFarmers: numeric(z.number().int().positive()), maxQuantity: numeric(z.number().positive().optional()), quantityUnit: z.string().default('kg'), bookingCutoffMinutes: numeric(z.number().int().nonnegative().default(60)), active: z.boolean().optional() });
